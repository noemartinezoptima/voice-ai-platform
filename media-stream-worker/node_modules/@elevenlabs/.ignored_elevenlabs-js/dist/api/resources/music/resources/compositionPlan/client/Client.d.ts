...
export declare class CompositionPlanClient {
     ...
     *     })
     */
    create(request: ElevenLabs.music.BodyGenerateCompositionPlanV1MusicPlanPost, requestOptions?: CompositionPlanClient.RequestOptions): core.HttpResponsePromise<ElevenLabs.music.CompositionPlanCreateResponse>;
    private __create;
}
