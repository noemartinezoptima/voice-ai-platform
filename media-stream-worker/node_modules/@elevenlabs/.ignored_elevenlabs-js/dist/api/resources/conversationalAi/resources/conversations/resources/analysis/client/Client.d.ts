...
export declare class AnalysisClient {
     ...
     *     })
     */
    runEvaluation(conversation_id: string, request: ElevenLabs.conversationalAi.conversations.RunConversationEvaluationsRequest, requestOptions?: AnalysisClient.RequestOptions): core.HttpResponsePromise<ElevenLabs.GetConversationResponseModel>;
    private __runEvaluation;
}
