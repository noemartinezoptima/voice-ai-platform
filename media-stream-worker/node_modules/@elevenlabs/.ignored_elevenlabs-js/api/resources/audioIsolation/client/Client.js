...
class AudioIsolationClient {
    ...
    __convert(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (request.fileFormat != null) {
                _body.append("file_format", serializers.AudioIsolationConvertRequestFileFormat.jsonOrThrow(request.fileFormat, {
    ...
    __stream(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield _body.appendFile("audio", request.audio);
            if (request.fileFormat != null) {
                _body.append("file_format", serializers.AudioIsolationStreamRequestFileFormat.jsonOrThrow(request.fileFormat, {
                    unrecognizedObjectKeys: "strip",
                }));
            }
            const _maybeEncodedRequest = yield _body.getRequest();
