...
* @see app/Http/Controllers/Web/DocumentsController.php:30
...
* @see app/Http/Controllers/Web/DocumentsController.php:64
* @route '/settings/documents'
*/
...
* @see app/Http/Controllers/Web/DocumentsController.php:89
...
* @see app/Http/Controllers/Web/DocumentsController.php:108
* @route '/settings/documents/{document}'
*/
...
* @see app/Http/Controllers/Web/DocumentsController.php:135
