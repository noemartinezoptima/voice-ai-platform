...
* @see app/Http/Controllers/Web/TeamMemberController.php:18
* @route '/team'
*/
...
* @see app/Http/Controllers/Web/TeamMemberController.php:54
* @route '/team/invite'
*/
...
* @see app/Http/Controllers/Web/TeamMemberController.php:91
...
* @see app/Http/Controllers/Web/TeamMemberController.php:114
* @route '/team/{user}'
*/
...
const TeamMemberController = { index, invite, update, destroy }
