...
* @see app/Http/Controllers/Web/FlowController.php:26
* @route '/flows'
*/
export const index = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: index.url(options),
...
* @see app/Http/Controllers/Web/FlowController.php:128
* @route '/flows/{flow}'
*/
export const show = (args: { flow: string | number } | [flow: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: show.url(args, options),
...
* @see app/Http/Controllers/Web/FlowController.php:80
* @route '/flows/{flow}'
*/
...
* @see app/Http/Controllers/Web/FlowController.php:114
* @route '/flows/{flow}'
*/
export const destroy = (args: { flow: string | number } | [flow: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: destroy.url(args, options),
...
* @see app/Http/Controllers/Web/FlowController.php:38
* @route '/flows/create'
*/
...
* @see app/Http/Controllers/Web/FlowController.php:67
...
* @see app/Http/Controllers/Web/FlowController.php:214
...
* @see app/Http/Controllers/Web/FlowController.php:141
...
* @see app/Http/Controllers/Web/FlowController.php:164
