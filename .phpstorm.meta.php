...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Domain\Call\Repositories\CallRepositoryInterface' => \App\Infrastructure\Persistence\Eloquent\Call\EloquentCallRepository::class,
            'App\Domain\Flow\Repositories\FlowRepositoryInterface' => \App\Infrastructure\Persistence\Eloquent\Flow\EloquentFlowRepository::class,
            'App\Domain\Tenant\Repositories\TenantRepositoryInterface' => \App\Infrastructure\Persistence\Eloquent\Tenant\EloquentTenantRepository::class,
    ...
    override(\config(), map([
            ...
            'elevenlabs.default_voice_id' => 'string',
            ...
            'filesystems.links./Volumes/ZeroCool/repos/voice-ai-platform/public/storage' => 'string',
            'horizon.name' => 'string',
            'horizon.domain' => 'NULL',
            'horizon.path' => 'string',
            'horizon.use' => 'string',
            ...
            'twilio.sip_domain' => 'string',
            'twilio.media_worker_url' => 'string',
...
'database.redis.horizon.options.prefix','deepgram.api_key','deepgram.model','deepgram.language','elevenlabs.api_key',
'elevenlabs.default_voice_id','elevenlabs.model','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Volumes/ZeroCool/repos/voice-ai-platform/public/storage',
...
'mail.markdown.theme','mail.markdown.paths','mail.markdown.extensions','openai.api_key','openai.model',
'openai.timeout','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'reverb.apps.apps.0.rate_limiting.enabled','reverb.apps.apps.0.rate_limiting.max_attempts','reverb.apps.apps.0.rate_limiting.decay_seconds','reverb.apps.apps.0.rate_limiting.terminate_on_limit','services.postmark.key',
...
'session.same_site','session.partitioned','session.serialization','twilio.account_sid','twilio.auth_token',
'twilio.sip_domain','twilio.media_worker_url','inertia.ssr.enabled','inertia.ssr.runtime','inertia.ssr.ensure_runtime_exists',
...
'horizon.jobs.show','horizon.index','sanctum.csrf-cookie','flows.index','flows.store',
'flows.show','flows.update','flows.destroy','calls.index','calls.show','tenants.index','tenants.store','tenants.show','tenants.update',
'tenants.destroy','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'welcome','horizon::layout','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','TWILIO_ACCOUNT_SID','TWILIO_AUTH_TOKEN',
'TWILIO_SIP_DOMAIN','DEEPGRAM_API_KEY','OPENAI_API_KEY','ELEVENLABS_API_KEY','ELEVENLABS_DEFAULT_VOICE_ID',
'MEDIA_STREAM_WORKER_URL','SANCTUM_TOKEN_PREFIX','REVERB_APP_ID','REVERB_APP_KEY','REVERB_APP_SECRET',
